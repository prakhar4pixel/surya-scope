...
def generate_solar_report(data: dict) -> io.BytesIO:
    ...
    financial_data = [
        ...
        ["Estimated Gross Cost", f"\u20b9 {data['total_cost_inr']:,.2f}"],
        ["PM Surya Ghar Subsidy", f"\u20b9 {data['subsidy_inr']:,.2f}"],
        ["Net Payable Cost", f"\u20b9 {data['net_cost_inr']:,.2f}"],
        ["Annual Electricity Savings", f"\u20b9 {data.get('annual_savings_inr', 0):,.2f}"],
